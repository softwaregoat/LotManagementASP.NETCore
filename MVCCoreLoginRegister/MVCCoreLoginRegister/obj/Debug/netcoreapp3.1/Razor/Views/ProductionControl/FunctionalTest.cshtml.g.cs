#pragma checksum "E:\Project\VisualStudio\Core\LotManagementASP.NETCore\MVCCoreLoginRegister\MVCCoreLoginRegister\Views\ProductionControl\FunctionalTest.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c8bc66b882fbdbb2a1a632803ca6c31f53a859b0"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c8bc66b882fbdbb2a1a632803ca6c31f53a859b0", @"/Views/ProductionControl/FunctionalTest.cshtml")]
...
");
    ...
    <script>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response != 'Failed') {
                                ...
                                for (var i = 0; i < response.length; i++) {
                         ");
                WriteLiteral(@"           var em = response[i];
                                    let tr = trs[i];
                            ...
                            ");
                WriteLiteral(@"        $($(tr).find('.result')).html('<option>' + em.result + '</option>');
       ...
       ");
                WriteLiteral(@"         if (CartonNo == '' || CartonNo == undefined) {
                ...
                $.ajax({
                    ...
                    data: {
                   ");
                WriteLiteral(@"     'CartonNo': CartonNo,
                        'Comment': Comment,
                        'Des': Des,
