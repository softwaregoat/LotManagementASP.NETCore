#pragma checksum "E:\Project\VisualStudio\Core\LotManagementASP.NETCore\MVCCoreLoginRegister\MVCCoreLoginRegister\Views\ProductionControl\FunctionalTest.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e85f224786a7aa3341fcfdca7641979acb136603"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e85f224786a7aa3341fcfdca7641979acb136603", @"/Views/ProductionControl/FunctionalTest.cshtml")]
...
");
    ...
    <script>
       ...
       ");
                WriteLiteral(@"                             $($(tr).find('.comment')).val(em.comment);
            ...
            $('input.log').click(function () {
                if ($(this).prop('checked')) {
                    ...
                    $(this).closest('tr').find('input.date-ti");
                WriteLiteral(@"me').val('');
        ...
        ");
                WriteLiteral(@"        if (SampleSize == '' || SampleSize == undefined) {
