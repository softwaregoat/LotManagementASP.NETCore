#pragma checksum "E:\Project\VisualStudio\Core\LotManagementASP.NETCore\MVCCoreLoginRegister\MVCCoreLoginRegister\Views\DataArchive\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0552f9cfac99c0f1cabf818fd0f7dcd30774fccc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0552f9cfac99c0f1cabf818fd0f7dcd30774fccc", @"/Views/DataArchive/Index.cshtml")]
...
");
            DefineSection("Scripts", async() => {
                WriteLiteral(@"
    <script>
import { Toast } from ""../../wwwroot/lib/bootstrap/dist/js/bootstrap.bundle"";
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != 'Failed') {
               ");
                WriteLiteral(@"         var items = '<option>Select Data Query</option>';
                        $(""#data-query"").empty();
                        for (var i = 0; i < response.length; i++) {
                            var em = response[i];
         ...
         ");
                WriteLiteral(@"       if ($('#Lot').val() == 'Select Lot') {
                    toastr.w
                }
                $.ajax({
                    type: ""POST"",
